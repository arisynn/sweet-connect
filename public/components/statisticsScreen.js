...
const StatisticsScreen = ({ profile, onClose, activeTheme }) => {
    ...
    const rows = [
        ...
        { label: 'Total Skor', value: formatNumber(s.totalScore || 0) },
        ...
        { label: 'Level Flawless', value: formatNumber(s.totalFlawless || 0) },
        ...
        { label: 'Revive Digunakan', value: formatNumber(s.totalRevivesUsed || 0) },
